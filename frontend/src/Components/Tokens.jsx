...
export function Tokens() {
    ...
    useEffect(() => {
        ...
        fetch('https://matrixlab.onrender.com/data')
        .then((res)=>{
            return res.json();
        }).then((resData)=>{
            setData(resData);
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="800" className="main4 flex py-16 flex-col items-center gap-16">
            ...
            {/* Loading Data from Api Image */}
            {loading && <img className="loadingimg w-2/12 m-auto mb-72 block" src={brandlogo} alt="loading" />}
